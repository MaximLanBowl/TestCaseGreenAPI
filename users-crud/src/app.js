...
app_data_source_1.myDataSource
    ...
    .catch(function (err) {
    console.log("Error from Data Source initialization!", err);
});
var app = express();
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    result = _a.sent();
                    return [2 /*return*/, res.send("".concat(result, " User was deleted"))];
            }
        });
    });
});
var PORT = 3000;
app.listen(PORT);
console.log("Server was started at port ".concat(PORT));
